              ...
              <View style={styles.marginBottom}>
                ...
                <TouchableOpacity
                  ...
                  <Image
                    ...
                    style={styles.logoStyle}></Image>
                  <Text style={styles.authOptionText}>
                    {AuthOptionsText.PhoneOption}
                  </Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.createAccountButton}>
                  <Text style={styles.createAccountText}>
                    {AuthOptionsText.CreateAccount}
                  </Text>
                </TouchableOpacity>
              </View>
              <Text style={styles.alreadyAccountTextStyle}>
                {AuthOptionsText.AlreadyAccount}
              </Text>
              <TouchableOpacity style={styles.loginButton}>
                <Text style={styles.alreadyAccountTextStyle}>
                  {AuthOptionsText.LoginText}
                </Text>
              </TouchableOpacity>
