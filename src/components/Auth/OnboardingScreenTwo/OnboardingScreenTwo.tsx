  ...
  return (
    <View style={styles.mainContainer}>
      <View style={styles.container}>
        <View>
          <View style={styles.childContainer}>
            ...
            <Image
              source={Images.OnboardingScreenTwoOne}
              style={styles.OnboardingScreenImageOneStyle}
            ></Image>
          </View>
          <View style={styles.childContainer}>
            <Image
              source={Images.OnboardingScreenTwoTwo}
              style={styles.OnboardingScreenImageOneStyle}
            ></Image>
          ...
          <View style={styles.childContainer}>
            ...
            <Image
              source={Images.OnboardingScreenTwoThrid}
              style={styles.OnboardingScreenImageOneStyle}
            ></Image>
          </View>
        </View>
      ...
      <View style={styles.progessBarStyle}>
        <CircularProgress fill={66} rotation={0} navigationScreen={ROUTES.OnboardingScreenThrid} />
      </View>
    </View>
  );
};
